    ...
    try {
        ...
        try {
            await (0, sendMail_1.default)({
                email: user.email,
                subject: "Activate your account on Social Network!",
...
exports.loginUser = (0, catchAsyncError_1.CatchAsyncError)(async (req, res, next) => {
    try {
        ...
        if (!user) {
            return next(new ErrorHandler_1.default("Invalid eamil or password", 400));
        }
...
exports.updateAccessToken = (0, catchAsyncError_1.CatchAsyncError)(async (req, res, next) => {
    try {
        ...
        if (!session) {
            return next(new ErrorHandler_1.default("Please login for this access this resources", 400));
        }
